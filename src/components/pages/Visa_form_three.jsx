...
import './visa_form_three.css'
import  { useRef } from 'react';
import emailjs from '@emailjs/browser';
import Popup from '../Popup';

function Visa_form_three() {
  ...
  return (
    ...
    <div className='visa-heading'>
        <div className='visa-sub-heading1'>
            <h1>STUDENT VISA</h1>
            <p>Effortless student visa services crafted for your academic journey abroad.</p>
        </div>
    </div>
    <div className='visa-content'>
      <div className='visa-content-heading stu'>
...
export default Visa_form_three