  ...
  return (
    ...
    <div className='visa-heading'>
        <div className='visa-sub-heading1'>
            <h1>TOEFL</h1>
            <p>Excel in your TOEFL exam with our expert guidance and tailored study plans.</p>
        </div>
    </div>
    <div className='visa-content'>
      ...
      <div className='visa-content-start'>
        ...
        <div className='visa-content-left-heading'><h1 >IELTS details</h1></div>
